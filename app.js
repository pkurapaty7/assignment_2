...
function get_weather_v1(request, response){
  if(request.headers.authorization == 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlByZWV0aGkiLCJpYXQiOjE1MTYyMzkwMjJ9.BlWCMZG2SHus_FHOh7qO7tYjaF1em--UGT9D63p47cU')
...
function post_auth(req,res){
    ...
    let usernames = ['nithish','sunny','kohli']
